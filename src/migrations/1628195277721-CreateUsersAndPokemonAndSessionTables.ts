...
export class CreateUsersAndPokemonAndSessionTables1628195277721 implements MigrationInterface {
    name = 'CreateUsersAndPokemonAndSessionTables1628195277721'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "pokemons" ("id" SERIAL NOT NULL, "name" text NOT NULL, "number" integer NOT NULL, "image" text NOT NULL, "height" integer NOT NULL, "weigth" integer NOT NULL, "baseExp" integer NOT NULL, "description" text NOT NULL, CONSTRAINT "PK_a3172290413af616d9cfa1fdc9a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "sessions" ("id" SERIAL NOT NULL, "token" character varying NOT NULL, "userId" integer, CONSTRAINT "REL_57de40bc620f456c7311aa3a1e" UNIQUE ("userId"), CONSTRAINT "PK_3238ef96f18b355b671619111bc" PRIMARY KEY ("id"))`);
